...
PROCEDURE AddQ(VAR Elt: CHAR); {Добавить Elt в конец очереди}
PROCEDURE DelQ; {Удалить первый элемент из очереди}
PROCEDURE HeadQ(VAR Elt: CHAR); {Копировать первый элемент очереди в Elt}
PROCEDURE WriteQ; {Копировать очередь в OUTPUT}
