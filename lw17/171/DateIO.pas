...
INTERFACE 
TYPE
  Month = (NoMonth, JAN, FEB, MAR, APR, MAY, JUN, {ѕеречисл€емый тип мес€ца}
                    JUL, AUG, SEP, OCT, NOV, DEC);
                    
PROCEDURE ReadMonth(VAR FIn: TEXT; VAR Mo: Month); {—читать мес€ц из файла}
PROCEDURE WriteMonth(VAR FOut: TEXT; VAR Mo: Month); {—копировать мес€ц в файл}

IMPLEMENTATION
PROCEDURE Read3Symbols(VAR FIn: TEXT; VAR Ch1, Ch2, Ch3: CHAR);
{Ѕезопасное чтение 3 символов}
BEGIN {Read3Symbols}
  Ch1 := '#'; 
  Ch2 := '#';
  Ch3 := '#';
...
{—читать 3 буквы, определить мес€ц по сокращенному названию}
VAR
  Ch1, Ch2, Ch3: CHAR;
BEGIN {ReadMonth}
  Mo := NoMonth;
  Read3Symbols(FIn, Ch1, Ch2, Ch3);
...
{¬ывести сокращенное название мес€ца}
VAR
  Ch1, Ch2, Ch3: CHAR;
BEGIN {WriteMonth}
